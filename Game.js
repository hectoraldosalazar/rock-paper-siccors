...
//Colocamos las opciones (Piedra, Papel y Tijeras)
...
//Tipos de estilo usando object variable sintaxt

//Style for the choice display row
...
//Styles the results... puts the hands a little farther apart
const resultStyle = {
  margin: 40,
  fontSize: 48,
  color: '#ffff'
...
// Handles the player's choice and determines the game results
